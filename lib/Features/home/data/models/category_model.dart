class Category {
  ...
  static const List<Category> categories = [
    Category(
      id: 1,
      imageUrl:
          'assets/images/services/analsysCenter.png',
    ...
    Category(
      id: 4,
      imageUrl:
          'assets/images/services/playstation.png',
    ...
    Category(
      id: 5,
      imageUrl:
          'assets/images/services/resturant.png',
    ...
    Category(
      id: 6,
      imageUrl:
          'assets/images/services/supermarket.png',
    ...
    Category(
      id: 7,
      imageUrl:
          'assets/images/services/workspace.png',
